...
// Email. Shared by the debt + history panels so the mapping lives in one place.
export function ProviderIcon({ provider, size = 13 }: { provider: IdentityProvider; size?: number }) {
  if (provider === "discord") {
    return (
